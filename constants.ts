...
Eligible Only Inpatient Services
* **This means when the Medicaid office finds out that the patient was in a facility or a rehab. When this code reflects, the patient needs to submit a discharge letter. If the patient wants, we can fax it to the Medicaid office. It might take around a month to update after the Medicaid office receives the document 
...
* **HomeFirst (HF):** Enrollment: **718-921-7772 / 866-360-1934**
